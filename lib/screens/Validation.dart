...
class _StorageDetailScreenState extends State<StorageDetailScreen> {
  ...
  String description = '';
  String backpackPrice = '0';
  String carrierPrice = '0';
  String miscellaneousPrice = '0';
  String refundPolicy = '';
  File? _selectedFile;
...
//               'storageImages',
//               // Ensure this matches the server's expected field
//               image!.path,
//               contentType: MediaType('image', 'jpeg'), // Specify content type
//             ),
//           );
//           print(
//               "################# 제발제발 Image added to request under 'images' field: ${image!.path}");
//         } else {
...
//           print(
//               'Failed to parse server error response. Raw response: ${responseBody}');
//           ScaffoldMessenger.of(context).showSnackBar(
